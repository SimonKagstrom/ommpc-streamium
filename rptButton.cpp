...
void RptButton::updateStatus(int mpdStatusChanged, mpd_Status* mpdStatus,
...
int RptButton::processCommand(int command, GuiPos& guiPos)
{
...
void RptButton::draw(SDL_Surface* screen, SDL_Surface* bg, bool forceRefresh)
{
